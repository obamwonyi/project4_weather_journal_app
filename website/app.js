...
//fetching the node with the id of temp from the dom
const temp = document.querySelector("#temp");
//fetching the node with the id of date from the dom
const dateOutput = document.querySelector("#date");
//fetching the node with the id of user_input from the dom
const user_input = document.querySelector("#user_input");
//fetching the node with the id of icon from the dom
const icon = document.querySelector("#icon");
//fetching the node with the id of discription from the dom
